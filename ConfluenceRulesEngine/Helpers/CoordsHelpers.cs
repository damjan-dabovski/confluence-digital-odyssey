...
{
    public static class CoordsHelpers
    {
        /*
         * 18[19]20[21]22[23]
           14[15]16[17]
        ...
        public static int GetPositionFromCoords(Coords coords)
        {
            ...
            var playerOffset = (int)coords.OwnerId * 12;

            var basePosition = coords.Program switch
            {
                Row.P1 => 0,
                Row.P2 when coords.Slot is Col.S1 => 2,
                Row.P2 when coords.Slot is Col.S2 => 4,
                Row.P3 when coords.Slot is Col.S1 => 6,
                Row.P3 when coords.Slot is Col.S2 => 8,
                Row.P3 when coords.Slot is Col.S3 => 10,
                _ => throw new ArgumentOutOfRangeException(nameof(coords))
            };

            return basePosition + interruptOffset + playerOffset;
        }
